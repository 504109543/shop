...
<div id="logo"><img src="${pageContext.request.contextPath}/images/bglogo.png" /></div>
</div>
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1>管理员登录</h1>
			<form id="loginForm" method="post" action="${pageContext.request.contextPath}/user_adlogin.action" onsubmit="return checkForm()">
				<table>
					<tr>
...
<div id="footer">
	Copyright &copy; 2015 shop All Rights Reserved.
		http://www.xxxx.com
</div>
</body>
</html>