...
<div region="north" style="height: 85px;background-color: #E0ECFF">
	<table style="padding: 2px" width="100%">
		<tr>
			<td width="50%">
				<div align="top"><img src="${pageContext.request.contextPath}/images/bglogo.png"/><font color="blue" size="6">shop后台管理系统</font></div>
			</td>
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px"><font color="red" size="10">欢迎使用shop后台管理系统</font></div>
		</div>
	</div>
</div>
